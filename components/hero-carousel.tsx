        ...
        {slides.map((slide, index) => (
          <SwiperSlide key={slide.id}>
            <div className="relative h-full">
                  ...
                  <div className="max-w-3xl">
                    ...
                    >
                      <div className="space-y-4">
                        ...
                        <motion.p
                          className="text-xl md:text-2xl text-khmer-gold font-semibold"
                          initial={{ opacity: 0, x: -30 }}
                          animate={{ opacity: 1, x: 0 }}
                      ...
                      >
                        ...
                        <CTAButton
                          ...
                          variant="outline"
                          size="lg"
                          className="bg-white/10 backdrop-blur-sm border-white/30 text-white hover:bg-white hover:text-gray-900 group"
                        >
              ...
              {/* Floating Elements */}
              <motion.div
                className="absolute top-1/4 right-10 w-20 h-20 bg-khmer-gold/20 rounded-full blur-xl"
                animate={{ 
                  y: [0, -20, 0],
                  scale: [1, 1.1, 1]
                }}
              ...
              <motion.div
                className="absolute bottom-1/4 right-1/4 w-16 h-16 bg-khmer-red/20 rounded-full blur-xl"
                animate={{ 
                  y: [0, 15, 0],
                  x: [0, 10, 0],
                  scale: [1, 0.9, 1]
